...
public class Instantiatior : MonoBehaviour
{
    ...
    public
     static string currentRecipeIndex {get; private set;}
    ...
    private void setRecipe(GameObject infoContainerPrefab)
    {
        ...
        if(infoContainerPrefab == infoContainerPrefabZoom)
        {
    ...
    private void setRecipeIndex(string index)
    {
        currentRecipeIndex = index;
    }

    private void setRestaurantIndex(string index)
    {
