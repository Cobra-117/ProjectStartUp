...
public class Instantiatior : MonoBehaviour
{
    ...
    {
        string fixedIndexBecauseMaxHadOneJob = (Int32.Parse(index) - 1);
        return Resources.Load<Sprite>("RestaurantImages/" + fixedIndexBecauseMaxHadOneJob.PadLeft(2, '0') + "_restaurant");
    }
}
